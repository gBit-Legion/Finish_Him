...
__C.GLOBAL.BASE_DIR = 'C:\\Users\\mides\\OneDrive\\Документы\\GitHub\\Finish_Him\\ArtificialIntelegence\\RSVbaseline'  # Base project folder

__C.GLOBAL.MODEL_SAVE_DIR = os.path.join(__C.GLOBAL.BASE_DIR, 'logs')
assert __C.GLOBAL.MODEL_SAVE_DIR is not None


__C.ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), 'C:\\Users\\mides\\OneDrive\\Документы\\GitHub\\Finish_Him\\ArtificialIntelegence\\RSVbaseline'))
